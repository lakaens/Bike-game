...
bool ModuleSceneIntro::Start()
{
	...
	cubetest.size = vec3(2, 0.2, 10);
	cubetest.color = White;
	cubetest.SetPos(0, 1, 10);
	cubetest.SetRotation(-25, { 1,0,0 });
	cube_test = App->physics->AddBody(cubetest, 0);
	cube_test->collision_listeners.add(this);
	return ret;
}

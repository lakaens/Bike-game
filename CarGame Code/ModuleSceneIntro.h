...
public:
	...
	*/
	...
	SDL_Texture* lastlap = NULL;
	SDL_Texture* texturetime = NULL;
	SDL_Texture* toplap = NULL;
	...
	char* topscore = "None";
	char* lastscore = "None";
	char* titlelast = "Last lap: ";
	char* titletop = "Fastest lap: ";
	char* titletime = "Lap Time: ";
	float lastscoref = 0;
	float topscoref = 9999;
	uint index = 0;
	bool timer_on = false;
	bool metabool = false;
	uint  metabooldisabled=0;
	uint delay = 0;
	uint  fmetabooldisabled = 0;
	uint delay2 = 0;
	float aux1 = 0, aux2 = 0, aux3 = 0;
	//******Sensor
	Cube meta, fmeta, floor, checkpoint1, checkpoint2, checkpoint3, checkpoint4, checkpoint5, checkpoint6, checkpoint7, checkpoint8;
	PhysBody3D* meta_, *fmeta_, *floor_, *checkpoint_1, *checkpoint_2, *checkpoint_3, *checkpoint_4, *checkpoint_5, *checkpoint_6, *checkpoint_7, *checkpoint_8;
	int checklist = 0;
	//******Constraint
	Cube constraintcube;
